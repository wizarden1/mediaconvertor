...
#		$audiotrack="--language 1:$aud_language --audio-tracks 1 --compression 1:none --no-video --no-subtitles --no-chapters ""$enctemp\temp.m4a"""
		$audiotrack="--language 0:$aud_language --audio-tracks 0 --compression 0:none --no-video --no-subtitles --no-chapters ""$enctemp\temp.m4a"""
	} else {
#		$audiotrack="--language 1:$aud_language --audio-tracks 1 --compression 1:none --no-video --no-subtitles --no-chapters ""$enctemp\temp$extension.$extension"""
...
#	$videotrack = "--language 1:$vid_language --default-track 1 --video-tracks 1 --compression 1:none --no-audio --no-subtitles --no-chapters ""$enctemp\temp.mkv"""
